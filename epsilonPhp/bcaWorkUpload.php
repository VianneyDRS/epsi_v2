...
<form action="bcaWorkUpload-validation.php?course=<?=$_GET['course']?>&challenge=<?=$_GET['challenge']?>" method="post" enctype="multipart/form-data">
  Selectionnez un ou plusieurs fichier à uploader:
...
<br>
<a href="listFichier.php?course=<?=$_GET['course']?>&challenge=<?=$_GET['challenge']?>">Voir la liste des fichiers uploadés</a>
